<?php
 ...
 class GeneratePage{
   // public static $LIB=["ctrl"=>EasyFrameWork::$Racines["dirAccess"]."/_ctrl","main"=>EasyFrameWork::$Racines["dirAccess"]];
    private $page;
    ...
    private function generateController(){
        $file=EasyFrameWork::$Racines["dirAccess"]."/_ctrl"."/{$this->page}Controller.php";
